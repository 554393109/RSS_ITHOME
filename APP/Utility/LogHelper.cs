...
namespace APP.Utility
{
    public class LogHelper
    {
        ...
        //private static readonly log4net.ILog logunifiedpay = log4net.LogManager.GetLogger("logunifiedpay");         //选择<logger name="logunifiedpay">的配置
        ...
        ///// </summary>
        ///// <param name="info"></param>
        //public static void UnifiedPayInfo(string info)
        //{
        //    if (logunifiedpay.IsInfoEnabled)
        //        logunifiedpay.Info(info);
        //}
    }
}