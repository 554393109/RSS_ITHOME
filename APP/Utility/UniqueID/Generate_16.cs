...
namespace APP.Utility.UniqueID
{
    public class Generate_16
    {
        private static object lock_Generate_16 = new object();								            //加锁对象
        ...
        private static long machineIdBits = 4L; 														//机器码字节数
        private static long datacenterIdBits = 0L;														//数据中心字节数
        ...
        //private static Generate_16 _generate_16;

        //public static Generate_16 Instance
        //{
        //    get
        //    {
        //        if (_generate_16 == null)
        //        {
        //            lock (lock_Generate_16)
        //            {
        //                if (_generate_16 == null)
        //                    _generate_16 = new Generate_16();
        //            }
        //        }
        //        return _generate_16;
        //    }
